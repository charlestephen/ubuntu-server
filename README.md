[![Bump version](https://github.com/charlestephen/ubuntu-server/actions/workflows/SemVer.yml/badge.svg?event=release)](https://github.com/charlestephen/ubuntu-server/actions/workflows/SemVer.yml)
